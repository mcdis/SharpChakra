...
namespace SharpChakra
{
   ...
   public static class Native
   {
      ...
      public static JsErrorCode JsGetTypedArrayStorage(JsValue _typedArray,
         ...
         => Is32
            ? Native32.JsGetTypedArrayStorage(_typedArray, out _buffer, out _bufferLength, out _arrayType,
               out _elementSize)
            : Native64.JsGetTypedArrayStorage(_typedArray, out _buffer, out _bufferLength, out _arrayType,
               out _elementSize);
      ...
      public static JsErrorCode JsGetTypedArrayInfo(JsValue _typedArray,
         ...
         => Is32
            ? Native32.JsGetTypedArrayInfo(_typedArray, out _arrayType, out _arrayBuffer, out _byteOffset,
               out _byteLength)
            : Native64.JsGetTypedArrayInfo(_typedArray, out _arrayType, out _arrayBuffer, out _byteOffset,
               out _byteLength);
      ...
      public static JsErrorCode JsParseSerializedScriptWithCallback(
         ...
         out JsValue _result)
         => Is32
            ? Native32.JsParseSerializedScriptWithCallback(_scriptLoadCallback, _scriptUnloadCallback, _buffer,
               _sourceContext, _sourceUrl, out _result)
            : Native64.JsParseSerializedScriptWithCallback(_scriptLoadCallback, _scriptUnloadCallback, _buffer,
               _sourceContext, _sourceUrl, out _result);
      ...
      public static JsErrorCode JsRunSerializedScriptWithCallback(
         ...
         out JsValue _result)
         => Is32
            ? Native32.JsRunSerializedScriptWithCallback(_scriptLoadCallback, _scriptUnloadCallback, _buffer,
               _sourceContext, _sourceUrl, out _result)
            : Native64.JsRunSerializedScriptWithCallback(_scriptLoadCallback, _scriptUnloadCallback, _buffer,
               _sourceContext, _sourceUrl, out _result);
      ...
      public static JsErrorCode JsSetModuleHostInfo(JsModuleRecord _module,
         ...
         => Is32
            ? Native32.JsSetModuleHostInfo(_module, JsModuleHostInfoKind.FetchImportedModuleFromScriptCallback,
               _callback)
            : Native64.JsSetModuleHostInfo(_module, JsModuleHostInfoKind.FetchImportedModuleFromScriptCallback,
               _callback);
      ...
      public static JsErrorCode JsParseModuleSource(
         ...
         => Is32
            ? Native32.JsParseModuleSource(_requestModule, _sourceContext, _script, _scriptLength, _sourceFlag,
               out _exception)
            : Native64.JsParseModuleSource(_requestModule, _sourceContext, _script, _scriptLength, _sourceFlag,
               out _exception);
