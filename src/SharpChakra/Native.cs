...
#else
         return Is32
            ? Native32.JsGetTypedArrayStorage(typedArray, out buffer, out bufferLength, out arrayType, out elementSize)
            : Native64.JsGetTypedArrayStorage(typedArray, out buffer, out bufferLength, out arrayType, out elementSize);
#endif
      }
...
#else
         return Is32
            ? Native32.JsGetTypedArrayInfo(typedArray, out arrayType, out arrayBuffer, out byteOffset, out byteLength)
            : Native64.JsGetTypedArrayInfo(typedArray, out arrayType, out arrayBuffer, out byteOffset, out byteLength);
#endif
      }
...
#else
         return Is32
            ? Native32.JsParseSerializedScriptWithCallback(scriptLoadCallback, scriptUnloadCallback, buffer, sourceContext, sourceUrl, out result)
            : Native64.JsParseSerializedScriptWithCallback(scriptLoadCallback, scriptUnloadCallback, buffer, sourceContext, sourceUrl, out result);
#endif
      }
...
#else
         return Is32
            ? Native32.JsRunSerializedScriptWithCallback(scriptLoadCallback, scriptUnloadCallback, buffer, sourceContext, sourceUrl, out result)
            : Native64.JsRunSerializedScriptWithCallback(scriptLoadCallback, scriptUnloadCallback, buffer, sourceContext, sourceUrl, out result);
#endif
      }
...
#else
         return Is32
            ? Native32.JsSetModuleHostInfo(module, JsModuleHostInfoKind.FetchImportedModuleFromScriptCallback, callback)
            : Native64.JsSetModuleHostInfo(module, JsModuleHostInfoKind.FetchImportedModuleFromScriptCallback, callback);
#endif
      }
...
#else
         return Is32
            ? Native32.JsParseModuleSource(requestModule, sourceContext, script, scriptLength, sourceFlag, out exception)
            : Native64.JsParseModuleSource(requestModule, sourceContext, script, scriptLength, sourceFlag, out exception);
#endif
      }
